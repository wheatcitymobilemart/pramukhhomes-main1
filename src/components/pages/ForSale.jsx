...
import { ForCardComponent } from "../elements";
...
const ForSale = () => {
  ...
  useEffect(() => {
    // Initial data setup
    setVisibleProperties(property1.slice(0, itemsPerPage));
    setCurrentImageIndexes(property1.slice(0, itemsPerPage).map(() => 0));
    setIsLoading(false);
  }, []);
  ...
  const handleNextImage = (index) => {
    setCurrentImageIndexes((prevIndexes) => {
      ...
      newIndexes[index] =
        (newIndexes[index] + 1) % visibleProperties[index].images.length;
      return newIndexes;
    });
  };
  ...
  const handlePrevImage = (index) => {
    setCurrentImageIndexes((prevIndexes) => {
      ...
      newIndexes[index] =
        (newIndexes[index] - 1 + visibleProperties[index].images.length) %
        visibleProperties[index].images.length;
      return newIndexes;
    });
  };
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="flex justify-center items-center text-center font-black text-3xl -mt-4 mb-4">Our Projects</div>
