    ...
    <Card className="w-full max-w-md mx-auto">
      <CardBody>
        ...
        <div className="flex items-center mb-6">
          ...
          <FaSearch
            size={24}
            className={`mt-3 text-gray-800 transition-colors duration-500 delay-75 hover:text-green-500 ${
              isFocused ? "text-[rgb(76,175,80)]" : "text-gray-800"
            }`}
          />
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center mt-2">
            <input
              ...
              className="w-full h-2 bg-green-300 rounded-lg appearance-none cursor-pointer range-slider"
            />
            <input
              type="range"
              min={0}
              ...
              className="w-full h-2 bg-green-300 rounded-lg appearance-none cursor-pointer ml-2 range-slider"
            />
          </div>
        ...
        <Button
          variant="text"
          color="green"
          className="text-gray-800 hover:text-green-500 mt-6 flex items-center"
            ...
            <div className="mt-4">
              <div className="flex flex-col mt-2">
                {amenitiesOptions.map((amenity) => (
                  <Checkbox key={amenity} label={amenity} color="green" />
                ))}
              </div>
            </div>
          </div>
...
export default ForRentSearchComponent;
