...
const Navbar = () => {
  const navItems = [
    { name: "Home", href: "/" },
    {
      ...
      href: "#",
      dropdown: [
        { name: "Iphone", href: "/PhoneChargingPortRepair " },
        { name: "Samsung", href: "/Samsung" },
        { name: "Battery", href: "/PhoneBatteryRepair" },
        { name: "Screen", href: "/PhoneScreenRepair" },
        { name: "Charging Port", href: "/PhoneChargingPortRepair" },
        { name: "Get Quotation", href: "/DeviceRepairBooking" },
