    ...
    <>
      <header className={navbarStyles.backgroundColor}>
        <div className="hidden md:block">
          ...
          >
            <a href="tel:+12047250858" className="group">Contact Us Today <span className="transition-all duration-300 ease-in-out transform group-hover:text-green-500">+12047250858</span></a>
